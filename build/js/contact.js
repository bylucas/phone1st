...
/**
     ...
     * limitations under the License.
     */
it("firebase","10.7.1","app");nt({apiKey:"AIzaSyBgOheePCJqT_ivlXs_EagQ3wQPGIMpJUg",authDomain:"howardlucas-7fcb0.firebaseapp.com",projectId:"howardlucas-7fcb0",storageBucket:"howardlucas-7fcb0.appspot.com",messagingSenderId:"945745527827",appId:"1:945745527827:web:3e282534ecdd22c66eabe6",measurementId:"G-QEE9Y648VB"});const nc=function(t,e,...n){if(t=g(t),bl("collection","path",e),t instanceof Al){const i=ls.fromString(e,...n);return Tl(i),new Rl(t,null,i)}{if(!(t instanceof kl||t instanceof Rl))throw new Gr(qr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=t._path.child(ls.fromString(e,...n));return Tl(i),new Rl(t.firestore,null,i)}}(function(t,e){const n="string"==typeof t?t:e||"(default)",i=function(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}("object"==typeof t?t:function(t=Q){const e=X.get(t);if(!e&&t===Q&&h())return nt();if(!e)throw tt.create("no-app",{appName:t});return e}(),"firestore").getImmediate({identifier:n});if(!i._initialized){const t=a("firestore");t&&Dl(i,...t)}return i}(),"contacts"),ic=document.querySelector(".contact-form"),rc=document.querySelector(".feedback");ic.addEventListener("submit",(t=>{t.preventDefault(),ec(nc,{name:ic.name.value,email:ic.email.value,message:ic.message.value,createdAt:new Gl("serverTimestamp")}).then((()=>{rc.style.display="block",setTimeout((()=>{rc.style.display="none",name.value="",email.value="",message.value=""}),3e3)}))}))}();